...
var clickables = ["img/hardWorking.jpg", "img/octagon2.jpg", "img/octagon3.jpg"];
var comeBack = true;

function hardWorking(){
  if(comeBack == true){
    document.getElementById("octagon1").style.backgroundImage ="url('img/hard.png')"
    document.getElementById("octagon1").style.transition = "all ease-in-out 500ms";
    comeBack = false;
  }else if (comeBack == false){
    document.getElementById("octagon1").style.backgroundImage ="url('img/hw.png')";
...
function minimalSupervision(){
  if(comeBack == true){
    document.getElementById("octagon2").style.backgroundImage ="url('img/minimal.png')";
    document.getElementById("octagon2").style.transition = "all ease-in-out 500ms";
    comeBack = false;
  }else if (comeBack == false){
    document.getElementById("octagon2").style.backgroundImage ="url('img/ms.png')";
    document.getElementById("octagon2").style.transition = "all ease-in-out 500ms";
    comeBack = true;
  }
}
...
function teamPlayer(){
  if(comeBack == true){
    document.getElementById("octagon3").style.backgroundImage ="url('img/team.png')";
    document.getElementById("octagon3").style.transition = "all ease-in-out 500ms";
    comeBack = false;

  }else if (comeBack == false){
    document.getElementById("octagon3").style.backgroundImage ="url('img/tp.png')";
    document.getElementById("octagon3").style.transition = "all ease-in-out 500ms";
    comeBack = true;
  }
}
